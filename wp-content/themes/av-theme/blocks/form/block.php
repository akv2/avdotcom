...
?><section id="<?php echo esc_attr( $id ); ?>" class="<?php echo esc_attr( $class ); ?>"><?php
  if( $is_preview ) :
    ...
    ?></div>
    Solely built and managed numerous websites and web applications from scratch for companies like 
    <a href="https://www.steelcase.com/" target="_blank">Steelcase</a>, <a href="https://www.tuuci.com" target="_blank">Tuuci</a>, <a href="https://www.stylexdesign.com/" target="_blank">Stylex</a>, <a href="https://www.disartnow.org" target="_blank">DisArt</a> and <a href="/showcase/">more</a>.<?php
  else:
